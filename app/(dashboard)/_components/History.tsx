...
function CustomTooltip({active, payload, formatter }: any) {
  ...
  return (<>
    <div className={cn("min-w-[300px] rounded border bg-background p-4", (!(expense>0) && !(income>0)) && "invisible", income > expense ? "border-emerald-500" : "border-red-500")}>
...
function TooltipRow({formatter, label, value, bgColor, textColor}: any) {
